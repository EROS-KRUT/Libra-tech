  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
           <li class="nav-item">
          <a class="nav-link active" href="Aeditpassword.aspx">Edit Password</a>
        </li>
             <li class="nav-item">
  <a class="nav-link active" aria-current="page" href="bookmanagement.aspx">Book Management</a>
        </li>
             <li class="nav-item">
          <a class="nav-link" href="bookdetails.aspx">Book Details</a>
        </li>          
          </ul>
          <ul class="navbar-nav">
                <li class="nav-item">
  <a class="nav-link active" aria-current="page" href="Amemberdetails.aspx">Member Details</a>
        </li>
                 <li class="nav-item">
