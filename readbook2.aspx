<%@ Page Language="C#" AutoEventWireup="true" CodeFile="readbook2.aspx.cs" Inherits="readbook2" %>
<!DOCTYPE html>
                     ...
                     <div class="col">
                        <hr/>
                         ...
                         <div class="form-group">
                           <asp:Button class="btn btn-success w-100 btn-lg" ID="Button1" runat="server" Text="Read this book" onclick="Button1_Click"/>
